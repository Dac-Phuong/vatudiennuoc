...
const submitProduct = () => {
    ...
    productData.post(route('admin.products.store'), {
        onSuccess: () => {
            productData.reset();
    ...
    <AppLayout>
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 lg:col-span-8 card mb-0">
                <div class="pb-6">
                    <h1 class="text-2xl font-bold mb-2">Thêm Sản Phẩm Mới</h1>
                    <p>Tạo sản phẩm cho cửa hàng</p>
                </div>
                ...
                <div class="flex justify-between items-center mt-8">
                    <div class="space-x-3 ml-auto">
                        ...
                        <Button label="Tạo sản phẩm" @click="submitProduct" :loading="submitting" />
                    </div>
                </div>
            </div>
