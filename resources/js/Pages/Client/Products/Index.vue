...
<template>
    ...
    <Head title="Tất cả sản phẩm">
        <meta name="description"
            content="Xem tất cả sản phẩm của chúng tôi. Tìm kiếm theo danh mục, giá cả và thương hiệu để tìm sản phẩm phù hợp với bạn." />
        <meta name="keywords" content="sản phẩm, mua sắm, thương hiệu, danh mục, giá cả, bán chạy, nổi bật" />
        <meta property="og:title" content="Tất cả sản phẩm - Cửa hàng của chúng tôi" />
        <meta property="og:description"
            content="Khám phá tất cả sản phẩm của chúng tôi. Tìm kiếm theo danh mục, giá cả và thương hiệu để tìm sản phẩm phù hợp với bạn." />
                    ...
                    <div class="w-[260px] flex-shrink-0 hidden md:block">
                        <div class="bg-white rounded-lg shadow-sm border p-4 sticky top-28">
                            ...
                            <div class="mb-6">
                                ...
                                <Dropdown v-model="localFilters.category_id" checkmark filter :options="categories"
                                    optionLabel="name" optionValue="id" placeholder="Chọn danh mục" class="w-full" />
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex justify-between text-sm text-gray-600 mt-2">
                                    <span>{{ formatPrice(localFilters.price_min) }}</span>
                                    <span>{{ formatPrice(localFilters.price_max) }}</span>
                                </div>
                            </div>
                    ...
                    <div class="mb-6"> <label class="block text-sm font-medium text-gray-700 mb-2">Khoảng giá</label>
                        <div class="px-2">
                            ...
                            <div class="flex justify-between text-sm text-gray-600 mt-2"> <span>{{
                                formatPrice(localFilters.price_min) }}</span> <span>{{
                                        formatPrice(localFilters.price_max) }}</span> </div>
                        </div>
                    </div> <!-- Brand Filter -->
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Thương hiệu</label>
