...
const handleClickOutside = (event) => {
    const dropdown = document.getElementById('profile-dropdown-wrapper');
        ...
        <div class="layout-topbar-actions">
            ...
            <div class="relative">
                <div id="profile-dropdown-wrapper">
                    <button type="button" @click="toggleDropdown" class="layout-topbar-action">
                        <i class="pi pi-user"></i>
                    </button>
                </div>

                <div v-if="isShow"
                    class="absolute right-0 mt-2 w-52 bg-white border border-gray-200 dark:border-surface-700 dark:bg-surface-900 rounded-md shadow-lg z-50">
                    <div class="flex items-center px-6 py-4 hover:bg-gray-100 dark:hover:bg-surface-800 cursor-pointer">
                        <i class="pi pi-user me-2"></i>
                        <span>My Profile</span>
                    </div>
                    <div @click="logout"
                        class="flex items-center px-6 py-4 hover:bg-gray-100 dark:hover:bg-surface-800 cursor-pointer">
